...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<nav role="navigation" class="site-navigation main-navigation">
			...
			<div class="icon-bar">
			<?php $permalink = get_permalink($parent); ?>
			<a href="<?php echo $permalink ?>" id="thumbnail-link" class="fullscreen-button"><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/quik_links.png" alt="Go Fullscreen"></a>
			</div>
